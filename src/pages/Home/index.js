      ...
      <div className={styles.cardContainer}>
        ...
        <div className={styles.socialContainer}>
          <a href='https://www.facebook.com/shubham.ojha.90/'>
            <CustomFontAwesomeIcon iconName={'facebook'} customStyle={styles.icon} />
          </a>
          <a href='https://www.linkedin.com/in/shubham-ojha-80b52a1a9/'>
            <CustomFontAwesomeIcon iconName={'linkedin'} customStyle={styles.icon} />
          </a>
          <a href='https://github.com/CommanderBaman'>
            <CustomFontAwesomeIcon iconName={'github'} customStyle={styles.icon} />
          </a>
        </div>
      </div>
    </div>
